          ...
          <Toolbar className={classes.content} disableGutters={true}>
            <div className={classes.flex}>
              <div>
                <Link className={classes.beefy} to="/">
                  <img
                    ...
                    src={
                      isMobile
                        ? require(`../../images/bifi-logos/logo-notext.png`).default
                        : require(`../../images/bifi-logos/logo.png`).default
                    }
                  />
                </Link>
              </div>
              <div className={classes.navbar}>
                <Hidden mdDown>
                  <NavItem title={'Header-Home'} url="/" Icon={VaultsIcon} />
